...
#====================================================================
class TeeCircle3(ChannelElement):
#--------------------------------------------------------------------
...
#--------------------------------------------------------------------
    ...
    if R is not None:
      ...
      self.get_tail_gate(1).PosElement = Vector(-self.dx * R, self.dy * R, 0)
      self.get_tail_gate(2).PosElement = Vector(-self.dx * R, -self.dy * R, 0)
