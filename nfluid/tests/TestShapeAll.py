...
if sys.argv[1] == "1":
  ...
  if el1 is not None:
    print "Name: ", el1.get_name(), "get_element_by_id 1: ", el1.print_info()
  if el2 is not None:
    print "Name: ", el2.get_name(), "get_element_by_id 2: ", el2.print_info()
  if el3 is not None:
    print "Name: ", el3.get_name(), "get_element_by_id 3: ", el3.print_info()
